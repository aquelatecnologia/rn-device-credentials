...
public class RNDeviceCredentialsModule extends ReactContextBaseJavaModule {

 private static final String TAG = "RNDeviceCredentials";
 ...
 public RNDeviceCredentialsModule(ReactApplicationContext reactContext) {
  super(reactContext);
